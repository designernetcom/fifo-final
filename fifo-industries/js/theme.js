((window.theme = {}),
  (window.theme.fn = {
    ...
    showErrorMessage(e, t) {
      $("html").hasClass("disable-local-warning") ||
  ...
  ((o = {}, d) => {
    try {
      "file://" === location.origin &&
        ...
        o.fn.showErrorMessage(
          ...
          'SVG Objects, Icons, YouTube and Vimeo Videos might not show correctly on local environment. For better result, please preview on a server.<br><br><a target="_blank" href="https://www.okler.net/forums/topic/how-to-disable-local-environment-warning/" class="fw-semibold"><i class="fa-solid fa-link"></i> How to Disable Local Environment Warning</a>',
        );
    } catch (e) {}
    (d.extend({
      browserSelector() {
      ...
      d('a[data-bs-toggle="tab"]').length &&
        (d('a[data-bs-toggle="tab"]').on(
          ...
          function ({ target: e }) {
            e = d(d(e).attr("href"));
            (e.length &&
              e.find(".owl-carousel").trigger("refresh.owl.carousel"),
              d(this)
                .parents(".nav-tabs")
                .find(".active")
                .removeClass("active"),
    ...
    if (
      (d(".notice-top-bar").length && a.init(),
    ...
    if (
      ...
      (e &&
        ...
        (s = !0),
        a.has("showStyleSwitcher") && (t = !0),
        a.has("hideStyleSwitcherAfterShow") && (s = !0),
      ...
      owlDots() {
        ...
        return (
          e.on("click", function (e) {
            ...
            return (
              e.preventDefault(),
              i.options.disableAutoPlayOnClick &&
                window.clearInterval(i.autoPlayInterval),
              !i.avoidMultipleClicks() &&
                ((e = s(this).index()), !t.hasClass("active")) &&
                void i.changeSlide(i.$el.find(".owl-item").eq(e))
            );
          }),
          this
        );
      ...
      events() {
        ...
        return (
          ...
          a.options.wrapper
            ...
            .on("click", (e) => {
              (e.preventDefault(),
                o(".gdpr-preferences-popup").addClass("show"));
            }),
                        ...
                        : 90 < e.progress && e.progress <= 95
                          ...
                          : 95 < e.progress && e.progress <= 99
                            ? ((e.animationInterval += 400),
                              s(".page-loader-progress").text(e.progress))
                            : 100 <= e.progress &&
                              s(".page-loader-progress").text(99),
                ["percentageProgress2"].includes(e.options.effect) &&
                  s(".loading-overlay-background-layer").css({
                    width: e.progress + "%",
                  }),
